    ...
    constructor() {
        ...
        this.translations = {
            en: {
                ...
                'game.victory_message': 'You collected {0} stars! Excellent work!',
                'game.wrong_answer': '❌ Wrong Answer',
                'game.wrong_answer_message': 'The correct answer was: "{0}"',
                'game.game_complete': '🌟 Game Complete!',
                'game.game_complete_message': 'You completed the Spaceship game with {0} stars!',
                'game.target_destroyed': '💥 Target Destroyed!',
                'game.target_destroyed_message': 'You destroyed the correct answer. Marking as Hard difficulty.',
                'game.wrong_answer_fallback_1': 'Wrong Answer 1',
            ...
            ru: {
                ...
                // Spaceship Game
                'game.victory': '🌟 Победа!',
                'game.victory_message': 'Вы собрали {0} звёзд! Отличная работа!',
                'game.wrong_answer': '❌ Неправильный ответ',
                'game.wrong_answer_message': 'Правильный ответ был: "{0}"',
                'game.game_complete': '🌟 Игра завершена!',
                'game.game_complete_message': 'Вы завершили игру Космический корабль с {0} звёздами!',
                'game.target_destroyed': '💥 Цель уничтожена!',
                'game.target_destroyed_message': 'Вы уничтожили правильный ответ. Отмечается как сложная сложность.',
                'game.wrong_answer_fallback_1': 'Неправильный ответ 1',
